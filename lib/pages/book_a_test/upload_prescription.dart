...
class _UploadPrescriptionState extends State<UploadPrescription> {
  ...
  int tabPosition;
  int slotSelected;
  String selectedHomeAddress;
  String selectedTestCenter;
...
//      margin: EdgeInsets.fromLTRB(30, 0, 30, 0),
  ...
  _getAddressBar() {
    List<Widget> homeAddressList = [];
    List<Widget> testCentreAddressList = [];

    addressList.forEach((address) {
      Widget homeWidget = GestureDetector(
        child: Container(
          alignment: Alignment.center,
...
//          height: 150,
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: selectedHomeAddress != null &&
                            selectedHomeAddress == address.id
                        ? Colors.grey[300]
                        : Colors.grey[100],
                    offset: Offset(5, 10),
                    spreadRadius: 0,
...
//            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: address.addressType != null
                        ? address.addressType == 'Home Address'
                            ? Container(
                                alignment: Alignment.centerLeft,
                                child: Icon(
                                  Icons.home,
                                  size: selectedHomeAddress != null &&
                                          selectedHomeAddress == address.id
                                      ? 28
                                      : 26,
                                  color: selectedHomeAddress != null &&
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                      ...
                      child: Text(
                        address.houseDetails,overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: selectedHomeAddress != null &&
                                  selectedHomeAddress == address.id
                              ? 15
                              : 14,
                        ),
              ...
              Text(
                '${address.areaDetails}, ${address.landmark}, ${address.city}, ${address.state}, ${address.pincode}',
      ...
      homeAddressList.add(homeWidget);
      homeAddressList.add(SizedBox(
        width: 10,
      ));
    });

    testCenterList.forEach((address) {
      Widget testCentre = GestureDetector(
        child: Container(
          alignment: Alignment.center,
          padding: EdgeInsets.all(10),
          width: (MediaQuery.of(context).size.width / 2) - 20,
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: selectedTestCenter != null &&
                          selectedTestCenter == address.id
                      ? Colors.grey[300]
                      : Colors.grey[100],
                  offset: Offset(5, 10),
                  spreadRadius: 0,
...
//            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  SvgPicture.asset(AssetConstants.marker_test_center),
                  Text(
                    '${address.distance/30} min',
              ...
              Container(
                child: Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: selectedTestCenter != null &&
                            selectedTestCenter == address.id
                        ? 15
                        : 14,
                  ),
...
//              SizedBox(height: 40,),
      ...
      testCentreAddressList.add(testCentre);
      testCentreAddressList.add(
        SizedBox(
          width: 15,
        ),
      );
          ...
          children: <Widget>[
            ...
            SingleChildScrollView(
              ...
              child: Container(
                padding: EdgeInsets.all(20),
                child: Row(
                  children: testCentreAddressList,
                ),
              ),
            ),
          ],
