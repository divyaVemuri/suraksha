...
//          height: 55,
        ...
        onTap: (){
          switch(tilename){
            case 'Book Home Collection': Navigator.push(context, CupertinoPageRoute(builder: (context)=>MyFamily(type: 'HomeCollection',)));
              break;
            case 'Book a test': Navigator.push(context, CupertinoPageRoute(builder: (context)=>MyFamily(type: 'BookATest',)));break;
